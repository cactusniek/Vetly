    ...
    en: {
        ...
        sections: {
            ...
            species: {
                ...
                goose: { title: 'Geese', text: 'Nothing is listed under this one yet.' },
                parrot: { title: 'Birds', text: 'Cage birds & ornamental birds belong to this group.' },
                pigeon: { title: 'Pigeons', text: 'Pigeons sit apart from the other poultry.' },
    ...
    nl: {
        ...
        sections: {
            ...
            species: {
                ...
                goose: { title: 'Ganzen', text: 'Hier staat nog niets op.' },
                parrot: { title: 'Vogels', text: 'Onder vogels horen kooivogels & siervogels.' },
                pigeon: { title: 'Duiven', text: 'Duiven staan apart van het andere pluimvee.' },
